...
const Footer = () => {
  return (
    <div className="bottom-0 z-50 fixed bg-[#232255] p-5 text-white w-screen flex justify-between ">
      ...
      <div>
        ...
        <div className=" bg-[#232255] cursor-pointer	font-extrabold text-white p-2 items-center justify-center flex rounded-full shadow-lg mx-5 border-2">
           Log In
          </div>
